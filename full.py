...
# f = open("./data/token.char_cnn.ft_tok.46_seed.dset", 'rb')
...
def read_instance(input_file, word_alphabet=alphabet.Alphabet('word'), char_alphabet=alphabet.Alphabet('character'),
                  label_alphabet=alphabet.Alphabet('label', True), number_normalized=True,
...
text_input = "מייקל סקוט (סטיב קארל), הבוס הילדותי שמנסה להוכיח לצוות הדוקומנטרי שהוא מצליח לנהל בצורה טובה משרד פרודוקטיבי ושמח."
